    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metric', models.CharField(choices=[('mass', 'масса'), ('volume', 'объем'), ('quantity', 'количество'), ('percent', 'процент'), ('miscellaneous', 'разное')], max_length=255, verbose_name='metric')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredients', to='ingredient.measurementunit', verbose_name='measurement unit'),
        ),
        migrations.AddConstraint(
            model_name='ingredient',
